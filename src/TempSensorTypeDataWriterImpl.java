public class TempSensorTypeDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements TempSensorTypeDataWriter
{
    ...
    public TempSensorTypeDataWriterImpl(TempSensorTypeTypeSupport ts)
    {
        typeSupport = ts;
