public class TempSensorTypeDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements TempSensorTypeDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private TempSensorTypeTypeSupport typeSupport;

    public TempSensorTypeDataReaderImpl(TempSensorTypeTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            TempSensorTypeSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            TempSensorTypeHolder received_data,
    ...
    */
    ...
    {
        return new TempSensorTypeDataReaderViewImpl(typeSupport);
    }
}
